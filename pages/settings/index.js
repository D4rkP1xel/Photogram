                ...
                <div className='w-full bg-slate-100 py-4 px-8 flex flex-col'>
                    <div className='flex gap-4 mt-4'>
                        ...
                        {description !== undefined ?
                            <>
                                <textarea ref={descriptionTextAreaRef} onChange={addCommentOnChange} value={descriptionText} className='overflow-hidden border border-slate-400 w-full h-[28px] pb-1'></textarea>
