...
function SignIn() {
    ...
    return (
        <div className="sm:w-8/12 lg:w-6/12 py-14 bg-green-600 mx-auto translate-y-24" style={{boxShadow: "0px 0px 6px 0px rgba(0,0,0,0.2)"}}>
            ...
            <div className="flex bg-stone-50 gap-4 justify-center w-3/4 mx-auto border-2 items-center select-none cursor-pointer" onClick={()=>signIn("google", {callbackUrl: "http://localhost:3000/verify?provider=google"}) }>
